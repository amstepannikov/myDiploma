...
password_change_date - DATETIME - дата/время изменения пароля  
...
is_active - INTEGER, NOT NULL - 1-активный пользователь, 0-заблокированный (в SQLite нет типа boolean)

### roles_users - таблица постов
